...
export declare const TransactionNamingScheme: EntityNamingScheme;
export declare enum TransactionDirection {
    Incoming = "incoming",
    Outgoing = "outgoing"
}
export declare enum TransactionInterval {
...
export declare enum TransactionRecurOn {
    ON_FIRST = 1,
    ON_SECOND = 2,
    ON_THIRD = 4,
    ON_FOURTH = 8,
...
export type RecurOnGroupKey = 'daysOfWeek' | 'daysOfMonth' | 'months' | 'weekOccurrence';
...
export declare const transactionFilterConfig: FilterConfig<TransactionFilters>;
